...
${ROOT}>.jf-tr-body{min-height:0;overflow:hidden;opacity:0;visibility:hidden;transition:opacity calc(var(--jf-tr-d)*.7) ease,visibility 0s linear var(--jf-tr-d)}
...
${ROOT}.jf-tr-settled>.jf-tr-body{overflow:visible}
